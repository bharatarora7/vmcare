...
var errFn = function (cb, err) {
	...
	if (err) { 
	    console.log("Entered into generic error handler");
		return cb(err); 
	}
};
...
console.log("Entered in  generate tokens ");
    ...
    console.log("the new token created is "+token);
...
aserver.exchange(oauth2orize.exchange.password(function(client, username, password, scope, done) {
	...
	console.log("Entered into server.exchange");
	...
	console.log("Entered generateTokens");
